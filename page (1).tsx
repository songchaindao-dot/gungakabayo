...
import { Leaf, Shield, Heart, Users, Target, Eye, Handshake, Sparkles, Award, DollarSign } from 'lucide-react'
...
export default function AboutPage(): JSX.Element {
  const coreValues: Array<Value> = [
    {
      icon: <Leaf className="w-8 h-8" />,
      title: 'Sustainability',
      description: 'Committed to environmentally friendly practices that protect our planet for future generations',
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: 'Quality',
      description: 'Delivering premium products that meet the highest standards of excellence',
    },
    {
  ...
  const whyChooseUs: Array<Reason> = [
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-[#007A3D] to-[#005A2D] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">About Gungakabayo</h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
            A proudly Zambian agribusiness company dedicated to sustainable and organic food production since 2019
          </p>
        </div>
      </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h2 className="text-4xl font-bold text-[#007A3D] mb-6">Our Story</h2>
                <p className="text-lg text-gray-600 mb-4">
                  Founded in 2019, Gungakabayo Enterprise Limited emerged from a vision to transform Zambian
                  agriculture. We started with a simple belief: that organic, sustainable farming methods could provide
                  healthier food while protecting our environment.
                </p>
                <p className="text-lg text-gray-600 mb-4">
                  Today, we've grown into one of Zambia's most trusted names in agribusiness, providing everything from
                  premium quail products to organic crops and processed foods. Our commitment to quality, sustainability,
                  and community has remained unchanged.
                </p>
                <p className="text-lg text-gray-600">
                  We work closely with local farmers, employ sustainable practices, and continuously innovate to bring
                  the best products to Zambian families while contributing to national food security.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative h-80 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[#007A3D]/70 flex items-center justify-center">
            <div className="text-center text-white px-4">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">Proudly Zambian</h2>
              <p className="text-xl md:text-2xl">Sustainable farming practices since 2019</p>
            </div>
          </div>
        </section>
      </ScrollReveal>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-lg text-gray-700">
                  We envision a future where Gungakabayo Enterprise Limited is recognized as the premier provider of
                  organic and sustainable food products throughout Zambia, setting the standard for quality, innovation,
                  and environmental responsibility in the agricultural sector.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700">
                  Our mission is to produce and distribute high-quality organic food products using sustainable farming
                  practices, while supporting local communities, promoting food security, and maintaining the highest
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-[#007A3D] mb-4">Our Core Values</h2>
                ...
                <ScrollReveal key={index} delay={index * 100}>
                  <Card className="bg-white border-2 border-[#EAD6B7] hover:border-[#007A3D] transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-2xl font-bold text-[#007A3D] mb-4">{value.title}</h3>
      ...
      <ScrollReveal>
        <section className="py-20 bg-[#EAD6B7]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-[#007A3D] mb-4">Why Choose Us</h2>
              <p className="text-xl text-gray-700 max-w-2xl mx-auto">
                Ten compelling reasons to partner with Gungakabayo Enterprise Limited
              </p>
            </div>
              ...
              {whyChooseUs.map((reason, index) => (
                <ScrollReveal key={index} delay={index * 50}>
                  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
                    ...
                    <h3 className="font-bold text-[#007A3D] mb-2">{reason.title}</h3>

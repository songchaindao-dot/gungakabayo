        ...
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              <div className="text-[#007A3D] font-bold text-xl">Gungakabayo</div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:0570095686" className="text-[#007A3D] hover:text-[#D15B2C] transition-colors">
              <Phone className="w-5 h-5" />
            </a>
            <a href="mailto:Gungakabayo@gmail.com" className="text-[#007A3D] hover:text-[#D15B2C] transition-colors">
              <Mail className="w-5 h-5" />
            </a>
            <Link href="/checkout" className="relative">
              <Button variant="ghost" size="icon" className="text-[#007A3D] hover:text-[#D15B2C] hover:bg-[#007A3D]/10">
            ...
            <SheetContent side="right" className="bg-white">
              <div className="flex flex-col space-y-6 mt-8">
                ...
                <div className="pt-4 border-t border-gray-200 space-y-3">
                  <a href="tel:0570095686" className="flex items-center space-x-2 text-[#007A3D]">
                    <Phone className="w-5 h-5" />
                    <span>0570 095 686</span>
                  </a>
                  <a href="mailto:Gungakabayo@gmail.com" className="flex items-center space-x-2 text-[#007A3D]">
                    <Mail className="w-5 h-5" />

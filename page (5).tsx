...
import { BookOpen, Sprout, Heart, Leaf, Download, Video, Clock } from 'lucide-react'
  ...
  const articles: Array<Article> = [
    {
      ...
      category: 'Farming',
      excerpt:
        'Organic farming is more than a trend—it\'s a commitment to sustainable agriculture. Learn about the numerous benefits including improved soil health, reduced chemical exposure, enhanced biodiversity, and better nutrition in crops.',
  ...
  const videos: Array<Video> = [
    {
      ...
      description: 'Learn the fundamentals of organic farming from experienced practitioners',
      thumbnail: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=600&q=80',
      duration: '12:30',
    },
    {
      title: 'Raising Healthy Chickens',
      description: 'Complete guide to chicken care, feeding, and disease prevention',
      thumbnail: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=600&q=80',
      duration: '15:45',
    },
    {
      title: 'Sustainable Agriculture Practices',
      description: 'Discover how to farm sustainably and protect the environment',
  ...
  const guides: Array<Guide> = [
    {
      ...
      description: 'A comprehensive PDF guide covering all aspects of organic farming',
      icon: <Download className="w-6 h-6" />,
    },
    {
      title: 'Livestock Care Manual',
      description: 'Detailed manual for raising and caring for various livestock',
      icon: <Download className="w-6 h-6" />,
    },
    {
      title: 'Crop Planning Calendar',
      description: 'Seasonal planting and harvesting guide for Zambian farmers',
      icon: <Download className="w-6 h-6" />,
    },
    {
      title: 'Food Safety Handbook',
      description: 'Essential food safety practices for farmers and consumers',
      icon: <Download className="w-6 h-6" />,
    },
  ]
      ...
      <section className="relative pt-32 pb-12 bg-gradient-to-br from-[#007A3D] to-[#005A2D] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Expand your knowledge with our educational resources on farming, sustainability, and healthy living
          </p>
        </div>
      </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-[#007A3D] mb-4">Featured Articles</h2>
              <p className="text-xl text-gray-600">Educational content to help you succeed in sustainable agriculture</p>
            </div>
                  ...
                  <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                    <div className="relative h-48 overflow-hidden group">
                      ...
                      <div className="absolute top-3 left-3">
                        <Badge className="bg-[#007A3D] text-white">{article.category}</Badge>
                      </div>
                    </div>
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-[#007A3D] mb-3">{article.title}</h3>
        ...
        <section className="py-20 bg-[#EAD6B7]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold text-[#007A3D] mb-4">Video Tutorials</h2>
              <p className="text-xl text-gray-700">Watch and learn from experienced farmers and experts</p>
            </div>
              ...
              {videos.map((video, index) => (
                <ScrollReveal key={index} delay={index * 100}>
                  <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                    ...
                    <CardContent className="p-6">
                      <h3 className="text-xl font-bold text-[#007A3D] mb-2">{video.title}</h3>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold text-[#007A3D] mb-4">Downloadable Guides</h2>
              <p className="text-xl text-gray-600">Free PDF guides to take your farming knowledge to the next level</p>
            </div>
                  ...
                  <Card className="bg-[#EAD6B7] border-none shadow-md hover:shadow-lg transition-all duration-300">
                    <CardContent className="p-6 flex items-center space-x-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-[#007A3D] mb-2">{guide.title}</h3>
                        <p className="text-gray-700 text-sm mb-3">{guide.description}</p>
                        <Button size="sm" className="bg-[#D15B2C] hover:bg-[#B14823] text-white">

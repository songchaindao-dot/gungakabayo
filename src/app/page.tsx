          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products">
                <Button
                  size="lg"
                  className="bg-[#D15B2C] hover:bg-[#B14823] text-white text-lg px-8"
                >
                  Shop Products
              ...
              <Link href="/learning">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-[#007A3D] text-lg px-8"
                >
                  Learn With Us
                </Button>
              </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                See our sustainable farming practices in action
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <Card className="bg-white border-none shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="p-6 bg-[#EAD6B7]">
                  ...
                  <p className="text-gray-700">
                    Our cattle graze on natural pastures, ensuring quality and
                    sustainability
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-none shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="p-6 bg-[#EAD6B7]">
                  ...
                  <p className="text-gray-700">
                    Sustainable farming practices for healthy, organic produce
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-none shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="p-6 bg-[#EAD6B7]">
                  ...
                  <p className="text-gray-700">
                    Hands-on approach to quality from field to table
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600">
                    100% organic farming methods ensuring the highest quality
              ...
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600">
                    Rigorous quality controls and safety standards at every
                    stage of production
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600">
                    Supporting local farmers and contributing to Zambia&apos;s
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Gungakabayo Enterprise Limited is a proudly Zambian agribusiness
                  company dedicated to producing high-quality organic and
                  sustainable food products. From livestock to crops to processed
                  foods, we&apos;re committed to feeding our nation naturally.
                </p>
                ...
                <Link href="/about">
                  <Button
                    size="lg"
                    className="bg-[#007A3D] hover:bg-[#006030] text-white"
                  >
                    Learn More About Us
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
        ...
        <section className="py-20 bg-gradient-to-br from-[#007A3D] to-[#005A2D] text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Explore our wide range of organic products and join thousands of
              satisfied customers across Zambia
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products">
                <Button

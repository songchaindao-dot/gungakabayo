...
export default function ContactPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      const url = `mailto:Gungakabayo@gmail.com?subject=Contact Form Submission&body=${encodeURIComponent(
        message
      )}`;
      ...
      <section className="relative pt-32 pb-12 bg-gradient-to-br from-[#007A3D] to-[#005A2D] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Get in touch with us for inquiries, orders, or partnership
            opportunities
          </p>
        </div>
      </section>
            ...
            <ScrollReveal>
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#007A3D] mb-4">
                    Call Us
                  </h3>
              ...
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 mt-2">
                    <a
                      href="https://www.gungakabayo.store"
                      className="hover:text-[#D15B2C] transition-colors"
                    >
            ...
            <ScrollReveal>
              <Card className="bg-white border-none shadow-xl">
                <CardContent className="p-8">
                  <h2 className="text-3xl font-bold text-[#007A3D] mb-6">
                    Send us a Message
                  </h2>
        ...
        <section className="py-16 bg-gradient-to-r from-[#007A3D] to-[#005A2D] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-white/90 mb-8">
              Subscribe to receive updates on new products, farming tips, and
              special offers
            </p>
            <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
              ...
              <Button
                type="submit"
                className="h-14 bg-[#D15B2C] hover:bg-[#B14823] text-white px-8"
              >
                Subscribe
              </Button>
            </form>
